...
//
//This code is updated by Moein Shakeri for the following paper:
//Moein Shakeri and Hong Zhang,"COROLA: A sequential solution to moving object detection using low-rank approximation", 
